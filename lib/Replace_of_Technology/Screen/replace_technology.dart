...
class ReplaceTechnologyScreen extends StatefulWidget {
  const ReplaceTechnologyScreen({Key? key}) : super(key: key);

  @override
  _ReplaceTechnologyScreenState createState() =>
      _ReplaceTechnologyScreenState();
}

class _ReplaceTechnologyScreenState extends State<ReplaceTechnologyScreen> {
  @override
      ...
      body: ListView(
        children: [
          ...
          Container(
            ...
            child: Text(
              "Quantity of Project Technology to be replaced:",
              style: heading,
            ),
          ),
          SizedBox(
          ...
          Container(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                ...
                // labelText: 'Full Name',
                hintText:
                    'Enter Quantity of Project Technology to be replaced:',
              ),
              validator: (value) {
                if (value!.isEmpty) {
                  return 'Enter Quantity of Project Technology to be replaced:';
                }
                return null;
              },
            ),
          ...
          Container(
            margin: const EdgeInsets.only(left: 20, right: 20),
            child: Text(
              "Number of replaced Project Technology:",
              style: heading,
            ),
          ),
          SizedBox(
          ...
          Container(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                ...
                // labelText: 'Full Name',
                hintText: 'Enter Number of replaced Project Technology',
              ),
              validator: (value) {
                if (value!.isEmpty) {
                  return 'Enter Number of replaced Project Technology';
                }
                return null;
              },
            ),
